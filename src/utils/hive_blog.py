...
def get_reward_draws_table(df):
    ...
    result += '|\n'
    result += '|' + image_hive_blog_150_url + static_values_enum.reward_draw_common_gold_icon_url
    result += '|' + image_hive_blog_150_url + static_values_enum.reward_draw_rare_gold_icon_url
    result += '|' + image_hive_blog_150_url + static_values_enum.reward_draw_epic_gold_icon_url
    result += '|' + image_hive_blog_150_url + static_values_enum.reward_draw_legendary_gold_icon_url
    result += '|\n'
    result += '| <center>GOLD Common: ' + str(get_sub_type_sum(df, 'gf_common_draw')) + 'x</center>'
    result += '| <center>GOLD Rare: ' + str(get_sub_type_sum(df, 'gf_rare_draw')) + 'x</center>'
    result += '| <center>GOLD Epic: ' + str(get_sub_type_sum(df, 'gf_epic_draw')) + 'x</center>'
    result += '| <center>GOLD Legendary: ' + str(get_sub_type_sum(df, 'gf_legendary_gold_draw')) + 'x</center>'
    result += '|\n'
